            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-header border-bottom">
                        <h3 class="card-title">افزودن تعرفه</h3>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('tariffs.store') }}" method="post" enctype="multipart/form-data" class="row g-3 needs-validation" novalidate>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="price" class="form-control" id="price" required value="{{ old('price') }}">
                                <div class="invalid-feedback">لطفا قیمت را وارد کنید</div>
                            </div>
                            <div class="col-md-6">
                                <label for="day" class="form-label">تعداد روز</label>
                                <input type="text" name="day" class="form-control" id="day" required value="{{ old('day') }}">
